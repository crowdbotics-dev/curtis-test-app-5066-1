"""
Django settings for curtis_test_app_5066_1 project.
...
ROOT_URLCONF = 'curtis_test_app_5066_1.urls'
...
WSGI_APPLICATION = 'curtis_test_app_5066_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Curtis Test App 5066 Support <support@curtis-test-app-5066-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "curtis_test_app_5066_1 API",
    "DESCRIPTION": "API documentation for curtis_test_app_5066_1 App",
    "VERSION": "v1",
}
